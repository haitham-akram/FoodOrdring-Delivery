                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="{{route('admin_store_res_manager')}}" method="post">
                                            @csrf
                                            <div class="form-body">
                                                ...
                                                <div class="row pl-1 pr-1">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-group">
                                                            <label
                                                                for="password">{{ __('admins.confirm-password') }}</label>
                                                            <input type="password" id="Password" class="form-control"
...
@endsection
@section('search js')
    @if (Session::has('create_msg_restaurantManager'))
        @if (App::getLocale() == 'ar')
            <script>
                toastr.success('{{ Session::get('create_msg_restaurantManager') }}', '{{ Session::get('success_title') }}', {
                    "showMethod": "fadeIn",
                    "hideMethod": "fadeOut",
                    timeOut: 3000,
        ...
        @endif
    @endif
    @if (Session::has('create_msg_Manager_with_ExistingRestaurant'))
        @if (App::getLocale() == 'ar')
            <script>
                toastr.success('{{ Session::get('create_msg_Manager_with_ExistingRestaurant') }}', '{{ Session::get('success_title') }}', {
                    "showMethod": "fadeIn",
                    "hideMethod": "fadeOut",
                    timeOut: 3000,
                    positionClass: 'toast-top-left',
