...
<link rel="stylesheet" type="text/css"
    href="{{ secure_asset('app-assets/css/core/menu/menu-types/vertical-menu-modern.css') }}">
...
{{-- this for login page--}}
<link rel="stylesheet" type="text/css" href="{{ secure_asset('app-assets/css/pages/login-register.css') }}">

<link rel="stylesheet" type="text/css" href="{{ secure_asset('app-assets/css/pages/users.css') }}">
<link rel="stylesheet" type="text/css" href="{{ secure_asset('app-assets/css/pages/dashboard-ecommerce.css') }}">
<!-- END Page Level CSS-->
<!-- BEGIN Custom CSS-->
