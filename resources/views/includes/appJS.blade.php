...
{{--  <script src="{{ secure_asset('app-assets/js/scripts/extensions/toastr.js') }}" type="text/javascript"></script> i dont need it --}}
{{--for tab in order page--}}
<script src="{{ secure_asset('app-assets/js/scripts/navs/navs.js') }}" type="text/javascript"></script>
  {{-- for ajax --}}
