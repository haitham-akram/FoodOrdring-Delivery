{{-- this for production --}}
<link rel="apple-touch-icon" href="{{ secure_asset('app-assets/images/logo/80.80.png') }}">
<link rel="icon" type="image/png" href="{{ secure_asset('app-assets/images/logo/80.80.png') }}">
...
<link rel="stylesheet" type="text/css" href="{{ secure_asset('app-assets/fonts/meteocons/style.css') }}">
<link rel="stylesheet" type="text/css"
    href="{{ secure_asset('app-assets/vendors/css/charts/chartist-plugin-tooltip.css') }}">

{{-- for login page --}}
<link rel="stylesheet" type="text/css" href="{{ secure_asset('app-assets/vendors/css/forms/icheck/icheck.css') }}">
<link rel="stylesheet" type="text/css" href="{{ secure_asset('app-assets/vendors/css/forms/icheck/custom.css') }}">
...
<link rel="stylesheet" type="text/css"
    href="{{ secure_asset('app-assets/css-rtl/core/menu/menu-types/vertical-menu-modern.css') }}">
<link rel="stylesheet" type="text/css"
    href="{{ secure_asset('app-assets/css-rtl/core/colors/palette-gradient.css') }}">
<link rel="stylesheet" type="text/css" href="{{ secure_asset('app-assets/fonts/simple-line-icons/style.css') }}">
{{-- this for login page --}}
<link rel="stylesheet" type="text/css" href="{{ secure_asset('app-assets/css-rtl/pages/login-register.css') }}">

<link rel="stylesheet" type="text/css" href="{{ secure_asset('app-assets/css-rtl/pages/users.css') }}">
<link rel="stylesheet" type="text/css" href="{{ secure_asset('app-assets/css-rtl/pages/dashboard-ecommerce.css') }}">
<!-- END Page Level CSS-->
<!-- BEGIN Custom CSS-->
...
<link rel="stylesheet" type="text/css"
    href="{{ secure_asset('app-assets/vendors/css/tables/extensions/rowReorder.dataTables.min.css') }}">
<link rel="stylesheet" type="text/css"
    href="{{ secure_asset('app-assets/vendors/css/tables/extensions/responsive.dataTables.min.css') }}">
